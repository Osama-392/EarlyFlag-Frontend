...
export default function PrincipalTeachersPage() {
 ...
 <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white text-center mb-2 ">
 ...
 <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white mb-2 ">All Caught Up!</h3>
