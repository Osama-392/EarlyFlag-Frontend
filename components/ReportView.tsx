...
export default function ReportView({
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1b1e2c]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* Header */}
      <div className="bg-white dark:bg-[#151722] border-b border-gray-200 dark:border-[#262a3d] sticky top-0 z-40 no-print">
      ...
      {/* Footer Actions */}
      <div className="bg-white dark:bg-[#151722] border-t border-gray-200 dark:border-[#262a3d] sticky bottom-0 z-40 no-print">
        <div className="max-w-6xl mx-auto px-8 py-6 flex items-center justify-between">
          <button 
            onClick={handlePrint}
