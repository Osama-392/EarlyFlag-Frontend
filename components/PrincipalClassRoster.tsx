...
export default function PrincipalClassRoster({ classId }: { classId: string }) {
 ...
 <div>
 <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white dark:text-white tracking-tight">
 {data.class_name}
 </h1>
 <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1 text-[15px]">
