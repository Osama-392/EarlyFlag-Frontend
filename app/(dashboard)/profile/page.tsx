...
export default function ProfilePage() {
 ...
 <div className="w-full h-full bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-500 rounded-full flex items-center justify-center text-3xl font-bold ">
 {userInitials}
 </div>
 </div>
 </div>
