...
export default function LoginPage() {
 ...
 {/* Logo */}
 <div className="mb-10 font-bold text-2xl md:text-[26px] tracking-[0.15em] flex items-center gap-2" >
 ...
 <h1 className="text-[26px] md:text-[30px] font-bold text-[#0f172a] mb-3" >
 Teacher Login
 </h1>
