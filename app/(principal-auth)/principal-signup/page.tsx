...
import PrincipalSignupForm from '@/components/PrincipalSignupForm';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md border border-blue-100">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Principal Registration</p>
        </div>

        <div className="mb-6 pb-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900" style={{ fontFamily: 'Sora' }}>Create Principal Account</h2>
          <p className="text-sm text-gray-600 mt-1">Set up your school administration profile</p>
        </div>
